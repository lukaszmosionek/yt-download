    ...
    <header>
      <div class="navbar navbar-dark bg-dark box-shadow">
		...
		<ul class="nav">
		  ...
		  <li class="nav-item">
			<a class="nav-link" href="#">Katalog (nowa podstrona)</a>
		  </li>
		  <li class="nav-item">
...
-->        
    ...
    <main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <form action="{{ route('download') }}" method="get" id="download">
                <input type="text" class="form-control" name="yt" id="yt" placeholder="https://www.youtube.com/watch?v=kJQP7kiw5Fk">
      ...
      <div class="album py-5 bg-light">
        <div class="container">
            <h1 style=text-align:center;">{{ __('home.lastDownload') }}</h1>
